...
import bg from "../../assets/images/wwd2.svg";
export default function Section3() {
  // console.log(data[1].heading);

  return (
    <div id="divisions" className="relative overflow-hidden">
      <Heading
        title="Our Divisions"
        background="Our Divisions"
      ...
      <img
        src={bg}
        className="absolute -bottom-0 right-0 z-[-10] translate-y-[20vh]"
      ></img>
    </div>
  );
}
