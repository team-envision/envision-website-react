...
export default function card({image,heading,description}){
    ...
    return(
        ...
        <div className="bg-[#ffffff10] w-[200px] h-[30vh] hover:cursor-pointer hover:scale-[1.02] hover:shadow-lg transition flex flex-col justify-center rounded-3xl group hover:bg-[#EF652230] ">
