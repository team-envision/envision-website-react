        ...
        <Fade top cascade>
          ...
          <div className="flex flex-col md:flex-row px-5">
            ...
            <div className="basis-4/6 p-5 font-[roboto] text-xl text-justify md:mt-0 -mt-12">
              Team Envision is a Multidisciplinary technical team of Aaruush
              that aims to provide solutions to most campus and societal issues
              and problems. Team Envision participated in various hackathons
              like the Rajasthan Hackathon,Mozofest Hackathon, Accenture
              Blockchain etc and won under various categories. Team Envision is
              a consortium of AI, IoT, Blockchain, Web designers etc who work
              closely to ideate, design, fabricate and develop products to
              tackle campus and community issues and problems.
            </div>
          </div>
        </Fade>
      </section>
